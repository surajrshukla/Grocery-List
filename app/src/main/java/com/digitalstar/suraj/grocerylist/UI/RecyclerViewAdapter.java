package com.digitalstar.suraj.grocerylist.UI;
...
import com.digitalstar.suraj.grocerylist.Activities.DetailsActivity;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        holder.dateAdded.setText(grocery.getItemAdded());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View view, final Context ctx) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("date", grocery.getItemAdded());
        ...
        public void editItem(final Grocery grocery) {
            ...
            final TextView title = (TextView) view.findViewById(R.id.groceryItemID);
